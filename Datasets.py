...
class InitDataset():
    ...
    def _get_user(self, profile_file):
        user_df = pd.read_csv(profile_file, header=None, names=['username','title','location','realname','register_time', 'homepage', 'selfdescriptions','num_reviews_written','num_member_visits','num_visits','fav_websites'])
